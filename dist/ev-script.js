...
define('text!ev-script/templates/playlist-embed-showcase-params.html',[],function () { return 'displayShowcase=true<% if (categoryList) { print(\'&displayCategoryList=true&categoryOrientation=\' + categoryOrientation); } %>\n';});
